...
import com.github.omerfarukicen.cassandraui.exception.UrlSyntaxException;
...
public class CassandraClientAdapter {
    ...
    public CompletableFuture<CassandraAdminTemplate> connect(ConnectionData connectionData) {
        return CompletableFuture.supplyAsync(() -> {
            ...
            assert adminTemplateField != null;
    ...
    public CompletableFuture<List<String>> getAllKeyspaces(String url, @NonNull String username,
